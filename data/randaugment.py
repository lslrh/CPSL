...
class RandAugmentMC(object):
    def __init__(self, n, m, jitter, radius=1.0, p=0.5):
        assert n >= 1
        assert 1 <= m <= 10
        self.n = n
        self.m = m
        ...
        self.jitter = transforms.ColorJitter(brightness=jitter, contrast=jitter, saturation=jitter, hue=min(0.5, jitter))
